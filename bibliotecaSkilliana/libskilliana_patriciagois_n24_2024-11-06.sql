...
# Tempo de Gera��o: 2024-11-06 13:15:37 +0000
# ************************************************************
...
CREATE TABLE `emprestimo` (
  ...
  CONSTRAINT `FK_utilizador` FOREIGN KEY (`id_utilizador`) REFERENCES `utilizador` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `user` (`username`, `pw`, `id_tipo`, `foto`, `tentativas_login`, `conta_bloqueada`)
VALUES
	('pat','moj29EMc8R3RW3qweyzyiA==',3,'assets/img/user/user.webp',1,0),
	('patricia','WVGBxE1qj/3mPMsycTtrYQ==',3,'assets/img/user/user.webp',0,0);

/*!40000 ALTER TABLE `user` ENABLE KEYS */;
UNLOCK TABLES;


# Dump da tabela utilizador
# ------------------------------------------------------------
...
INSERT INTO `utilizador` (`id`, `nome`, `morada`, `telefone`, `email`, `numfunc`, `numcc`, `datanasc`, `id_tipo`)
VALUES
	...
	(6,'Joana','a','123456789','email','008',0,'1993-07-10',3);
